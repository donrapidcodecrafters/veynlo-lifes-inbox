...
export class SavedItemsService {
  ...
  async create(ownerUserId: string, dto: { title: string; url?: string; note?: string; tags?: string[] }) {
  ...
  async list(ownerUserId: string, filter: { archived?: boolean } = {}) {
  ...
  async update(id: string, ownerUserId: string, dto: { title?: string; note?: string; tags?: string[]; pinned?: boolean; archived?: boolean }) {
