...
describe("extractSchemaOrgFromHtml — real markup", () => {
  ...
  it("returns nothing for an email with no markup at all", () => {
    ...
    expect(found).toEqual({ orders: [], parcels: [], reservations: [], invoices: [], blocksSeen: 0, blocksRejected: 0 });
...
const EMPTY = { orders: [], parcels: [], reservations: [], invoices: [], blocksSeen: 0, blocksRejected: 0 };
