...
// AttentionService gained a NotificationDeliveryService dependency after this test was written (it was
// lost in the force-push before that landed — see PROJECT_AUDIT.md DEF-082). scanForMissingExpectedEvents
// reaches neither collaborator: it reads recurringStreams and calls fileIfNew, which is why positional
// stubs are enough here.
const attention = new AttentionService(db, {} as never, {} as never);
